...
import { defineRetryFlow } from "./flowExtensions";
import {
...
import { ai, gemini20FlashExp, imagen3 } from "./vertexAi";
...
export const generateImageFlow = defineRetryFlow(
	...
	async (input) => {
		...
		logger.error("Image generation failed after multiple attempts.");
